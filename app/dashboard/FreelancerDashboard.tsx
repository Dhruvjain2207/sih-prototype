        ...
        <div className="nav-right">
          ...
          <div className="nav-icon-container">
            ...
            {activeMenu === 'notifications' && (
              <div className="dropdown-menu history-menu glass-panel" style={{ width: '340px', background: '#0b1329', borderColor: 'rgba(56, 189, 248, 0.3)' }}>
                ...
                <div className="favorites-list" style={{ maxHeight: '280px', overflowY: 'auto' }}>
                  {notifications.length === 0 ? (
                    ...
                    notifications.map((n) => (
                      <div key={n._id} style={{ padding: '0.75rem 1rem', borderBottom: '1px solid rgba(255,255,255,0.06)', background: n.isRead ? 'transparent' : 'rgba(56, 189, 248, 0.06)' }}>
                        <div style={{ fontWeight: 700, fontSize: '0.85rem', color: '#ffffff' }}>{n.title}</div>
                ...
                <div key={req._id} className="freelancer-card">
                  ...
                  <div style={{ display: 'flex', gap: '0.75rem', marginTop: '0.5rem' }}>
                    <button
                      ...
                      style={{ flex: 1, background: 'rgba(34, 197, 94, 0.15)', border: '1px solid rgba(34, 197, 94, 0.4)', color: '#22c55e', padding: '0.6rem', borderRadius: '8px', fontWeight: 700, fontSize: '0.85rem', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.3rem' }}
                    >
                    ...
                    <button
                      ...
                      disabled={submittingAction}
                      style={{ background: 'rgba(239, 68, 68, 0.12)', border: '1px solid rgba(239, 68, 68, 0.3)', color: '#ef4444', padding: '0.6rem 0.8rem', borderRadius: '8px', fontWeight: 600, fontSize: '0.85rem', cursor: 'pointer' }}
                    >
                      Reject
                    </button>
                  </div>
