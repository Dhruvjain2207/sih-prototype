        ...
        <section className={`${styles['left-panel']} ${isLoaded ? styles.loaded : ''}`}>
          <div className={styles['form-container']}>
            ...
            <div className={styles['form-header']}>
              <h1>Welcome Back</h1>
              <p>Sign in to your EasyService account as a {role === 'freelancer' ? 'Freelancer' : 'Client'}.</p>
            </div>
            ...
            <div className={styles['role-selector']}>
              ...
              >
                ...
                <span className={styles['role-title']}>Client Login</span>
              ...
              >
                ...
                <span className={styles['role-title']}>Freelancer Login</span>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className={styles['btn-submit']} disabled={loading}>
                {loading ? 'Signing In...' : `Sign In as ${role === 'freelancer' ? 'Freelancer' : 'Client'}`}
              </button>
            </form>
